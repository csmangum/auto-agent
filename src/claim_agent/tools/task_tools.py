...
def create_document_request(
    ...
    Use when you need to formally request a document (police report, estimate,
    rental_receipt, rental_agreement, medical records, etc.) and track when it is received.
