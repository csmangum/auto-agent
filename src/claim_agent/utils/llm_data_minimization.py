...
_CREW_ALLOWLISTS: dict[str, frozenset[str]] = {
    ...
    "router": frozenset({
        ...
        "loss_state", "attachments", "prior_claim_id", "reopening_reason", "is_reopened",
        "existing_claims_for_vin", "damage_tags", "definitive_duplicate",
        "is_economic_total_loss", "is_catastrophic_event", "damage_indicates_total_loss",
        "damage_is_repairable", "vehicle_value", "damage_to_value_ratio", "high_value_claim",
    ...
    "duplicate": frozenset({
        "claim_id", "policy_number", "vin", "vehicle_year", "vehicle_make", "vehicle_model",
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "existing_claims_for_vin", "damage_tags", "definitive_duplicate",
    }),
    # New claim crew: minimal for FNOL
    "new": frozenset({
        "claim_id", "policy_number", "vin", "vehicle_year", "vehicle_make", "vehicle_model",
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "loss_state", "attachments",
    }),
    # Fraud detection: needs incident/damage, vehicle; no party PII
    "fraud": frozenset({
        "claim_id", "policy_number", "vin", "vehicle_year", "vehicle_make", "vehicle_model",
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "status", "payout_amount", "loss_state",
        "pre_routing_fraud_indicators", "high_value_claim",
    }),
    # Partial loss: repair estimate, shop assignment, parts
    "partial_loss": frozenset({
        "claim_id", "policy_number", "vin", "vehicle_year", "vehicle_make", "vehicle_model",
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "status", "payout_amount", "loss_state", "attachments",
    }),
    ...
    "total_loss": frozenset({
        ...
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "status", "payout_amount", "loss_state", "attachments",
        "vehicle_value", "damage_to_value_ratio", "is_economic_total_loss",
    }),
    ...
    "reopened": frozenset({
        "claim_id", "policy_number", "vin", "vehicle_year", "vehicle_make", "vehicle_model",
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "status", "prior_claim_id", "reopening_reason", "loss_state",
    }),
    ...
    "escalation_check": frozenset({
        ...
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "status", "payout_amount", "loss_state",
        "router_confidence", "router_reasoning", "raw_output",
        "existing_claims_for_vin", "definitive_duplicate", "high_value_claim",
    }),
    # Task planner: loss_state for compliance deadlines
    "task_planner": frozenset({
        "claim_id", "policy_number", "vin", "vehicle_year", "vehicle_make", "vehicle_model",
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "status", "payout_amount", "loss_state", "workflow_output",
    }),
    ...
    "liability_determination": frozenset({
        "claim_id", "incident_date", "incident_description", "damage_description",
        "claim_type", "status", "loss_state", "workflow_output",
    }),
    ...
    "settlement": frozenset({
        ...
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "claim_type", "status", "payout_amount", "loss_state", "workflow_output",
        "liability_percentage", "liability_basis",
    }),
    ...
    "siu": frozenset({
        "id", "claim_id", "siu_case_id", "policy_number", "vin", "vehicle_year",
        "vehicle_make", "vehicle_model", "incident_date", "incident_description",
        "damage_description", "status", "claim_type", "state",
    }),
    "follow_up": frozenset({
    ...
    "dispute": frozenset({
        "claim_id", "policy_number", "vin", "vehicle_year", "vehicle_make", "vehicle_model",
        "incident_date", "incident_description", "damage_description", "estimated_damage",
        "payout_amount", "claim_type", "status",
    }),
    ...
    "claim_review": frozenset({
        "id", "status", "claim_type", "policy_number", "vin", "incident_date",
        "incident_description", "damage_description", "payout_amount", "created_at", "updated_at",
    }),
}
...
def minimize_claim_data_for_crew(
    ...
    *,
    ...
    if not enabled and not mask_pii:
