...
from claim_agent.tools import create_claim_task, update_claim_task, get_claim_tasks, get_claim_notes
...
def create_task_planner_agent(llm: LLMProtocol | None = None) -> Agent:
    ...
    return Agent(
        ...
        tools=[create_claim_task, update_claim_task, get_claim_tasks, get_claim_notes],
        verbose=True,
        llm=llm,
    )
