...
TOKEN BUDGET: Your after-action note MUST stay under {max_tokens} tokens (~{max_tokens * 4} characters). This note serves as the canonical claim state for future interactions, so it must be dense and information-rich without being verbose. Prioritize facts over narration.
